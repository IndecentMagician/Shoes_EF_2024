!(function (e) {
        ...
        (e.fn.sectionPosition = function (t, a) {
            e(this).each(function () {
                ...
                (n = Math.floor(c.height() / 2)),
                    ...
                    "top-half" === s ? (e(i).css("padding-bottom", r + n + "px"), c.css("margin-top", "-" + n + "px")) : "bottom-half" === s && (e(i).css("padding-top", o + n + "px"), c.css("margin-bottom", "-" + n + "px"));
            });
        });
        ...
        (e.fn.shapeMockup = function () {
            e(this).each(function () {
                var t = e(this),
                    ...
                    s = t.data("bottom"),
                    i = t.data("left");
                t.css({ top: a, right: n, bottom: s, left: i }).removeAttr("data-top").removeAttr("data-right").removeAttr("data-bottom").removeAttr("data-left").parent().addClass("shape-mockup-wrap");
            });
        }),
            ...
            e(this).each(function () {
                ...
                var s = setInterval(function () {
                    ...
                    o < 10 && (o = "0" + o),
                        ...
                        c < 10 && (c = "0" + c),
                        l < 10 && (l = "0" + l),
                        i < 0 ? (clearInterval(s), t.addClass("expired"), t.find(".message").css("display", "block")) : (n(".day").html(o), n(".hour").html(r), n(".minute").html(c), n(".seconds").html(l));
                }, 1e3);
            });
        }),
    ...
    TweenMax.to({}, 0.016, {
        repeat: -1,
        onRepeat: function () {
            (y += (w - y) / 9), (C += (k - C) / 9), TweenMax.set(b, { css: { left: y - 12, top: C - 12 } });
        },
    }),
